...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str,default='/userhome/cs2/xq141839/hku_project/Medical_SAM/segpc2021/data/images', help='the path of images')
    parser.add_argument('--csvfile', type=str,default='/userhome/cs2/xq141839/hku_project/Medical_SAM/segpc2021/test_train_data.csv', help='two columns [image_id,category(train/test)]')
    ...
    val_files = list(df[df.category=='validation'].image_id)
    train_files = list(df[df.category=='train'].image_id)
    
    train_dataset = sam_inputer(args.dataset,train_files)
    val_dataset = sam_inputer(args.dataset,val_files)
    ...
    model_ft = decoder.Model(img_channels = 3, n_classes = 3)
