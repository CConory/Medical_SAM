...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='/userhome/cs2/xq141839/hku_project/Medical_SAM/segpc2021/data/images',type=str, help='the path of dataset')
    parser.add_argument('--csvfile', default='/userhome/cs2/xq141839/hku_project/Medical_SAM/segpc2021/test_train_data.csv',type=str, help='two columns [image_id,category(train/test)]')
    parser.add_argument('--model',default='save_models/epoch_60_0.7356949663162231.pth', type=str, help='the path of model')
    ...
    test_dataset = sam_inputer(args.dataset,test_files)
    ...
    print('mean F1-score: {:.4f}, {:.4f}'.format(np.mean(f1_score),np.std(f1_score)))
